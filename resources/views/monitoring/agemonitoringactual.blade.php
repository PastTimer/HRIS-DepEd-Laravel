        ...
        <div class="row mb-4">
            ...
            <div class="col-md-6">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body text-center py-3">
                        <div class="btn-group-custom">
                            <a class="btn btn-primary" style="background-color: #0473B4; border: none;" href="{{ route('monitoring.age.actual') }}">
            ...
            <div class="col-12">
                <div class="card shadow">
                    <div class="card-header bg-transparent py-2">
                        <h6 class="text-uppercase text-muted ls-1 mb-0">Personnel Age Distribution (Actual Age)</h6>
                    </div>
...
<script>
    ...
    function drawAgeChart() {
        ...
        google.visualization.events.addListener(chart, 'select', function() {
            ...
            if (age !== null) {
                window.location.href = "{{ route('monitoring.age.group') }}?mode=actual&age=" + encodeURIComponent(age);
            }
        });
