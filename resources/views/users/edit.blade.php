                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <select id="role" name="role" class="form-control @error('role') is-invalid @enderror" onchange="updateAccessLevel()" required>
                                            ...
                                            <option value="school" {{ old('role', $user->role) == 'school' ? 'selected' : '' }}>School User</option>
...
<script>
    ...
    // We use the $user->access_level as the fallback if there's no old() input from a failed validation
    const oldAccessLevel = "{{ old('access_level', $user->access_level) }}";
    ...
    function updateAccessLevel() {
        ...
        // Reset dropdown
        accessSelect.innerHTML = '<option value="" disabled>-- Select Access Level --</option>';
    ...
    // Run immediately on page load to set the correct access level options based on their current role
