                ...
                <div class="card shadow">
                    ...
                    <div class="card-body bg-secondary">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <label>Type</label>
                                <input type="text" name="type" class="form-control" placeholder="e.g. Managerial, Supervisory, Technical" required>
                            </div>
                            <div class="col-md-6">
                                <label>Sponsor</label>
                                <input type="text" name="sponsor" class="form-control" placeholder="e.g. DepEd, CHED" required>
                            </div>
                        </div>
                        @if($isPersonnel)
